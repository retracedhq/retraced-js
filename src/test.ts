...
@suite class RetracedJSTests {
  ...
  @test public "should generate a GraphQL query string requesting all fields"() {
    /*
    const queryTerms: Retraced.StructuredQuery = {
      action: "user.*",
      crud: "c",
      received_start: "2017-06-01T00:00:00Z",
      received_end: "2017-07-01T00:00:00Z",
      created_start: "2017-06-01T00:00:00Z",
      created_end: "2017-07-01T00:00:00Z",
      actor_id: "user@domain.xyz",
      actor_name: "Chauncey O'Farragut",
